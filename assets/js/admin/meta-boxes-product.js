...
jQuery( function( $ ) {
	...
	// Add rows.
	$( 'button.f9mediaproduct_add_attribute' ).on( 'click', function() {
		var size         = $( '.f9mediaproduct_product_attributes .woocommerce_attribute' ).length;
		var attribute    = $( 'select.f9mediaproduct_attribute_taxonomy' ).val();
		var $wrapper     = $( this ).closest( '#f9mediaproduct_product_attributes' );
